...
//Keys for using encryption with mongoose-encryption
const encKey = process.env.BYTE32_BASE64_STRING;
const sigKey = process.env.BYTE64_BASE64_STRING;
...
//Encryption with mongoose-encryption
